                    ...
                    <div class="row match-height">
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-text">Available Balance:
                                        <strong>{{ $data['sum_deposit'] ? '$' . number_format((float) $data['sum_deposit'], 2, '.', '') : '$00.00' }}</strong>
                                    </h4>
                                    <a class="btn btn-danger" data-toggle="modal" data-target="#DepositModal"><i
                                            data-feather='plus-circle'></i></a>
                                    <a class="btn btn-info" data-toggle="modal" data-target="#TransferModal"><i
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $bonus_amount = App\Models\CashWallet::where('user_id', \Auth::id())
                                        ->get()
                                        ->sum('bonus_amount');
                                    ...
                                    <h4 class="card-text">Available Balance:
                                        {{ isset($bonus_amount) ? '$' . number_format((float) $bonus_amount, 2, '.', '') : '$00.00' }}
                                    </h4>
                                    <a class="btn btn-danger" data-toggle="modal" data-target="#walletWithdraw"><i
                                            data-feather='arrow-down-circle'></i></a>
                                    <a class="btn btn-info" data-toggle="modal" data-target="#walletTransfer"><i
                                            data-feather='send'></i></a>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $current_package = App\Models\User::where('id', Auth::id())
                                        ->select('package_id')
                                        ->first();
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $earnings = App\Models\CashWallet::where('user_id', Auth::id())
                                        ->where('note', 'Bonus')
                                        ->get()
                                        ->sum('bonus_amount');
                                    //dd($transferData);
                                    ...
                                    <h2 class="card-text">
                                        <strong>{{ isset($earnings) ? '$' . number_format((float) $earnings, 2, '.', '') : '$00.00' }}</strong>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3">
                            <?php
                            $withdraw = App\Models\Withdraw::where('user_id', \Auth::id())
                            ...
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text">
                                        <strong>{{ isset($withdraw) ? '$' . number_format((float) $withdraw, 2, '.', '') : '$00.00' }}</strong>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $transferData = App\Models\AddMoney::where('user_id', Auth::id())
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $refferals = App\Models\User::where('sponsor', Auth::id())
                                        ->get()
                                        ->count('id');
                                    //dd($refferals);
                                    ?>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $total_sponsor_bonus = App\Models\CashWallet::where('user_id', Auth::id())
                                        ->where('method', 'Sponsor Bonus')
                                        ->get()
                                        ->sum('bonus_amount');
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $total_daily_bonus = App\Models\CashWallet::where('user_id', Auth::id())
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $total_royality_bonus = App\Models\CashWallet::where('user_id', Auth::id())
                                        ->where('method', 'royality sponsor bonus')
                                        ->get()
                                        ->sum('bonus_amount');
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    <?php
                                    $total_level_bonus = App\Models\CashWallet::where('user_id', Auth::id())
